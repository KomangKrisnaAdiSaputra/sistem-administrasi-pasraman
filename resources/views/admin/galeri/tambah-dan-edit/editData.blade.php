<form action="{{ route('galeri.update', $id_galeri) }}" method="POST" class="form form-vertical"
    ...
    <div class="form-body">
        <div class="row">
            ...
            <div class="col-12 mt-4" style="text-align: center;">
                <div class="form-group">
                    <img src="{{ asset('/image/galeri/' . $data->foto) }}" alt="" height="20%" width="50%"
